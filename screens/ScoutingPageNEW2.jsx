        ...
        <SafeAreaView style={styles.mainView}>
            <View style={styles.container}>
                <Tab.Navigator
                    ...
                    <DictContext.Provider value={{dict, updateDict}}>
                        <Tab.Screen
                            name="Pre-Match"
                            component={PrematchNavigate}
                        />
                        <Tab.Screen name="Auton" component={AutonNavigate} />
                        <Tab.Screen name="Teleop" component={TeleopNavigate} />
                        <Tab.Screen
                            name="Endgame"
                            component={EndgameNavigate}
                        />
